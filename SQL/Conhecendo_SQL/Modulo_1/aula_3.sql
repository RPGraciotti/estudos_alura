...
-- -- adicionei um shortcut para rodar apenas a seleção por vez
...
VALUES (
    ...
    '3', 'Maria Fernandes', 'maria.fernades@email.com', 'rua santo antonio, 10'
), (
...
CREATE TABLE tabela_pedidos_gold(
    ...
    DatadoPedido_gold DATE,
    Status_gold VARCHAR(50),
    TotaldoPedido_gold DECIMAL(10,2),
    Cliente_gold INT,
    DatadeEnvioEstimada_gold DATE,
